...
from utils.functions import getCheckEmbed
...
async def ab_check_ctx(ctx:CM.Context, client:CM.Bot=None, user=None, guild=None, channel=None, is_guild=None, is_owner=None, has_value=None, has_permission=None, bot_has_permission=None, has_mod_role=None):
